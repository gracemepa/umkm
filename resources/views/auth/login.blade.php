              ...
              <div class="col-md-5 col-12 box-shadow-2 p-0">
                <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                  <div class="card-header border-0 text-center">
                    ...
                    <h4 class="text-primary font-weight-bold" style="font-size: 24px; margin-top: 15px;">Login to Your Account</h4>
                  </div>
                  <!-- Success Message -->
                  @if(session('success'))
                  ...
                  <form action="{{ route('login.submit') }}" method="POST" class="form-horizontal">
                    <fieldset class="form-group position-relative has-icon-left">
                      <input type="text" name="username" class="form-control form-control-lg rounded-pill" id="user-name" placeholder="Username" required>
                      <div class="form-control-position">
                        <i class="ft-user"></i>
                      </div>
                    </fieldset>
                    <fieldset class="form-group position-relative has-icon-left">
                      <input type="password" name="password" class="form-control form-control-lg rounded-pill" id="user-password" placeholder="Password" required>
                      <div class="form-control-position">
                        <i class="la la-key"></i>
                      </div>
                    </fieldset>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6 col-12 text-center text-sm-right">
                        <a href="{{ route('forgot-password.form') }}" class="card-link">Forgot Password?</a>
                      </div>
                    </div>
                    
                    @csrf
                    <!-- Login Button -->
                    <button type="submit" class="btn btn-outline-info btn-block mt-2 rounded-pill"><i class="ft-unlock"></i> Login</button>
                  </form>

                  <!-- Register Link -->
                  <div class="card-body text-center">
                    <p>Don't have an account? <a href="{{ route('register') }}" class="btn btn-outline-danger btn-block mt-2 rounded-pill"><i class="ft-user"></i> Register</a></p>
                  </div>
                </div>
              </div>
            </div>
