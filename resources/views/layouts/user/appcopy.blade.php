      ...
      <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
          <div class="main-menu-content">
              <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                  ...
                  <!-- Menu Shop -->
                  <li class="nav-item {{ Request::routeIs('user.produk.index') ? 'active' : '' }}">
                  ...
                  <!-- Menu Produk Detail -->
                  <li class="nav-item {{ Request::routeIs('user.produk.detail') ? 'active' : '' }}">
                      <a href="{{ route('user.produk.detail', 1) }}"> <!-- ID 1 adalah contoh, sesuaikan dengan ID produk yang dimaksud -->
