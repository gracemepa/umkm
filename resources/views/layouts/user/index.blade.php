                                        ...
                                        <div class="product-cat" id="categories">
                                            <ul class="treeview">
                                                @forelse($kategoris as $kategori)
                                                    <!-- Link untuk filter produk berdasarkan kategori -->
                                                    <li><a href="{{ route('user.filter', $kategori->id_kategori) }}">{{ $kategori->nama_kategori }}</a></li>
                                                @empty
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                <div class="product-action d-flex justify-content-around mt-3">
                                                    <a href="{{ route('user.detail', $produk->id_produk) }}" data-toggle="tooltip" data-placement="top" title="Details"><i class="ft-eye"></i></a><span class="separator">|</span>
